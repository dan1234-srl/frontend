...
// ─── DEFINIRE MENIURI ÎN AFARA COMPONENTEI PENTRU A PREVENI RE-RANDAREA ───
const MENU_GROUPS = [
  {
    group: "Administrare",
  ...
  return (
    <div className="fixed inset-0 flex bg-white font-sans overflow-hidden w-full h-screen selection:bg-[var(--royal-violet)] selection:text-white">
      ...
      <div className="flex-1 flex flex-col h-full bg-[var(--background)] overflow-hidden relative">
        ...
        <main className="flex-1 overflow-y-auto w-full overflow-x-hidden relative z-10 bg-white">
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
              ...
              className="p-4 sm:p-6 lg:p-10 will-change-transform min-h-full"
            >
              <Outlet />
            </motion.div>
          </AnimatePresence>
