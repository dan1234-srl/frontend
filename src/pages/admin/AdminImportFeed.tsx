...
import {
  ...
  FileText,
  Sliders,
  Plus, // 🚀 Restabilit importul pentru pictograma de adăugare
} from "lucide-react";
...
const MAPPING_FIELDS = [
  ...
  { label: "Imagine Principală (URL)", key: "imagine", required: false },
  {
    ...
    key: "imagini_galerie",
    required: false,
  }, // 🚀 Păstrat suportul pentru lotul de imagini suplimentare
...
const AdminImportFeed = () => {
  ...
  return (
    <div className="w-full space-y-10 pb-20 animate-in fade-in duration-700 font-sans text-left">
      {/* 🚀 HEADER ACTIONS: Butonul de adăugare se va ascunde curat DOAR când ești în interiorul panoului de editare */}
