...
const Orders = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] flex flex-col font-sans">
      ...
      <main className="flex-1 pt-40 pb-24 px-6 md:px-12 lg:px-24 max-w-[1600px] mx-auto w-full">
          ...
          <div className="space-y-16">
            <AnimatePresence mode="popLayout">
              {filteredOrders.length > 0 ? (
                ...
                <div className="py-40 text-center rounded-[3rem] border border-dashed border-zinc-100 bg-zinc-50/30">
                  <ShoppingBag
            ...
            {(orders.length >= ordersPerPage || currentPage > 1) && (
              <div className="flex justify-center items-center gap-10 border-t border-zinc-100 pt-12">
                <button
                  ...
                  className="size-14 rounded-full border border-zinc-100 flex items-center justify-center hover:bg-black hover:text-white transition-all disabled:opacity-20"
                >
                  <ChevronLeft size={20} />
                </button>
