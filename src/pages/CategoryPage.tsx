...
const CategoryPage = () => {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col overflow-x-hidden selection:bg-[var(--royal-violet)] selection:text-white font-sans antialiased">
      ...
      {/* WRAPPER CORECT DE IMPINGERE ÎN JOS - REZOLVĂ NATIV ORICE COMPORTAMENT FLUID AL HEADER-ULUI */}
      <div className="w-full flex-grow flex flex-col pt-[12rem] sm:pt-[13rem]">
        <main className="flex-grow w-full max-w-[1800px] mx-auto px-4 md:px-12 py-4">
          ...
          {/* NAVIGARE MOBIL */}
          <div className="lg:hidden flex items-center gap-2 mb-8 sticky top-28 z-30 bg-white/95 py-2 backdrop-blur-sm">
            <Sheet>
          ...
          <div className="flex items-center justify-between py-5 mb-12 border-y border-zinc-100 sticky top-24 md:top-28 bg-white/95 backdrop-blur-md z-40">
            <button
          ...
          <div className="flex gap-12 items-start">
            <aside className="hidden lg:block w-[250px] shrink-0 sticky top-48">
      ...
      {/* STILIZARE HIGH-END SECURIZATĂ (FĂRĂ CALCULE DE DIMENSIUNI FIXE GENERATOARE DE BUG-URI) */}
      <style
        dangerouslySetInnerHTML={{
          __html: `
        [data-radix-focus-guard] + [role="dialog"] { z-index: 10001 !important; }
        
        /* Overlay-ul se deschide curat pe tot ecranul, lăsând header-ul neatins */
        ...
        /* Drawer-ul de lux ocupă ecranul nativ cu o umbră discretă */
