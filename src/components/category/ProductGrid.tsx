...
/**
 * Grid de produse — fără stagger / fără "apariție treptată".
 * Cardurile apar imediat (reservation prin aspect-ratio), iar imaginile
 * folosesc LQIP + cross-fade, ceea ce ascunde latența pe 2G/3G și elimină
 * senzația de jitter / layout shift.
 */
const ProductGrid = ({
  products = [],
  loading,
